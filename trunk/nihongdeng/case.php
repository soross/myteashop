...
if(isset($_GET['key'])&&!empty($_GET['key'])){
	$where = $where." and (case_name like '%".$_GET['key']."%' or case_desc like '%".$_GET['key']."%') ";
}

//分页
$pagesize = 12;//一页显示多少条
$queryTotal = $db->query("select id from obj_case" .$where);
...
//案例
$prodRow = getRows("obj_case ".$where ."order by create_date desc limit $firstcount, $displaypg " ,$db);
$smarty->assign("caseRows",$prodRow);
