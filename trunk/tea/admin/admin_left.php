	...
	<BODY>
		<CENTER>
							        ...
							        <TR>
										<TD>
											<IMG src="images/menu.gif" align=absMiddle border=0>&nbsp;
									  		<A href="admin_main.php" target=main>配置信息</A>
									  	</TD>
									</TR>
							        <TR>
							        	<TD>
			...
			<TABLE class=Menu cellSpacing=0 style="margin-top:5px">
				<TBODY>
					<TR>
						<TH onClick="javascript:menu_tree('left_2');" align=middle>≡ 新闻内容 ≡</TH>
					</TR>
					<TR id=left_2>
						<TD>
							<TABLE width="100%">
								...
								-->
	        						...
	        						<TR>
										<TD>
											<IMG src="images/menu.gif" align=absMiddle border=0>&nbsp;
		  									<A href="admin_news_add.php" target=main>添加新闻</A>
		  								</TD>
									</TR>
 								</TBODY>
 							</TABLE>
	 		...
	 		<TABLE class=Menu cellSpacing=0 style="margin-top:5px">
				<TBODY>
					<TR>
						<TH onClick="javascript:menu_tree('left_3');" align=middle>≡ 产品发布 ≡</TH>
					</TR>
					<TR id=left_3>
						<TD>
							<TABLE width="100%">
        						<TBODY>
							        <TR>
										<TD>
											<IMG src="images/menu.gif" align=absMiddle border=0>&nbsp;
									  		<A href="admin_prod_class.php" target=main>产品分类</A>
									  	</TD>
									</TR>
		        					<TR>
										<TD>
											<IMG src="images/menu.gif" align=absMiddle border=0>&nbsp;
		  									<A href="admin_prod_list.php" target=main>产品列表</A>
		  								</TD>
									</TR>
	        						<TR>
										<TD>
											<IMG src="images/menu.gif" align=absMiddle border=0>&nbsp;
		  									<A href="admin_prod_add.php" target=main>添加产品</A>
		  								</TD>
									</TR>
 								</TBODY>
 							</TABLE>
