<?php /* Smarty version 2.6.26, created on 2011-06-28 03:57:02
         compiled from prod/prodlist.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'prod/prodlist.html', 107, false),)), $this); ?>
...
<div id="productquery">
	<div class="fang" style="width:140px;height:107px">
		...
		<a href="<?php echo $this->_tpl_vars['prodRow'][$this->_sections['list']['index']]['prod_info_url']; ?>
" target="_blank" ><img src="../product/images/<?php echo $this->_tpl_vars['prodRow'][$this->_sections['list']['index']]['prod_picture']; ?>
" alt="<?php echo $this->_tpl_vars['prodRow'][$this->_sections['list']['index']]['prod_name']; ?>
" style="width:140px;height:107px" border="0" /></a>
		</div>
	</div>
	<a href="<?php echo $this->_tpl_vars['prodRow'][$this->_sections['list']['index']]['prod_info_url']; ?>
" target="_blank" class="prodtitle" title="<?php echo $this->_tpl_vars['prodRow'][$this->_sections['list']['index']]['prod_name']; ?>
