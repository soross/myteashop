					...
					<DIV id=Wrap>
						<DIV id=Container>
							<DIV class=IndexDo><!--左边菜单部分开始-->
								...
								<LI><A id="ProdTypeLink" class=current href="/web/prod/austria.php">奥地利BOHLER系列</A>
								...
								<DIV class=greybg>
									<DIV class=step1Form>
										...
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/bohler/bohler_1.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/bohler/bohler_2.gif" />
										</LI>
										</UL>
										<UL>
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
