										...
										<logic:iterate id="dept" name="deptList">
											...
											<tr>
												<td height="20" bgcolor="#FFFFFF">
													<div align="center">
														<input type="checkbox" name="phones"
															value="${dept.id}" onclick="changePChkb(this);" />
													</div>
												</td>
												<td height="20" bgcolor="#FFFFFF">
													<div align="center">
														<span class="STYLE1">${dept.id}</span>
													</div>
												</td>
												<td bgcolor="#FFFFFF">
													<div align="center">
														<span class="STYLE1">${dept.deptName}</span>
													</div>
												</td>
												<td bgcolor="#FFFFFF">
													<div align="center">
														<span class="STYLE1">
														<logic:equal value="-1"  name="dept" property="pid">父级</logic:equal>
														<logic:iterate id="sondept" name="deptList">
															<logic:equal value="${dept.pid}"  name="sondept" property="id">
																${sondept.deptName}
															</logic:equal>
												...
												<td colspan="2" height="20" bgcolor="#FFFFFF">
													<div align="center">
														<span class="STYLE4">
															<a onclick="javascript:location.href='${pageContext.request.contextPath}/admin/dept.do?task=updateDept&deptid=${dept.id}';" style="cursor: hand;"><img src="${pageContext.request.contextPath}/admin/images/list.gif" width="10" height="10" border="0" /></a>[<a onclick="javascript:location.href='${pageContext.request.contextPath}/admin/dept.do?task=updateDept&deptid=${dept.id}';" style="cursor: hand;">详细信息</a>]
															&nbsp;&nbsp;
															<a onclick="deleteDept(${dept.id});" style="cursor: hand;"><img src="${pageContext.request.contextPath}/admin/images/del.gif" width="16" height="16" border="0" /></a>[<a onclick="deleteDept(${dept.id});" style="cursor: hand;">删除信息</a>]</span>
													</div>
												</td>
											</tr>
										</logic:iterate>
