...
<body>
	...
	<html:form action="/admin/template?task=templateList" method="post">
	<table width="100%" border="0" align="center" cellpadding="2"
		cellspacing="1" class="tableBorder">
		<tr>
	...
	<table id="listtab" width="98%" border="0" align="center" cellpadding="3"
		...
		<tr align="center" class="thstyle">
		 ...
		 <logic:present name="TemplateList">
          	<logic:iterate id="icd" name="TemplateList">          	 
				<tr align="center" style="cursor: hand;">
					...
					<td>
						<a href="${pageContext.request.contextPath}/admin/template.do?task=toUpdateTemplate&id=${icd.id}"><img src="${pageContext.request.contextPath}/admin/images/edit.gif" border="0">[修改]</a>
						<a href="${pageContext.request.contextPath}/admin/template.do?task=deleteTemplate&id=${icd.id}" onclick="return confirm('是否确定删除!');"><img src="${pageContext.request.contextPath}/admin/images/del.gif" border="0">[删除]</a>
					</td>
				</tr>					
	          </logic:iterate>
          </logic:present>
