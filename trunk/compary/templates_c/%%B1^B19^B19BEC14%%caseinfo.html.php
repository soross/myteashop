<?php /* Smarty version 2.6.26, created on 2011-06-27 03:06:39
         compiled from case/caseinfo.html */ ?>
...
<div id="productcontent">
	<div class="productpics">
		<div class="piczone">
			...
			<td align="center">
			<div id="productview">
			<img src="../product/images/<?php echo $this->_tpl_vars['prodinfo']['prod_picture']; ?>
" border="0" id="productloading" class="productpic">
			<!--
				<img src="../images/loading.gif" border="0" id="productloading" class="productloading">
				<input type="hidden" id="imgPath" name="imgPath" value="../product/images/<?php echo $this->_tpl_vars['prodinfo']['prod_picture']; ?>
">
			 -->
			</div>
			</td>
...
' target="_block"><?php echo $this->_tpl_vars['prodinfo']['prod_link']; ?>
		...
		<div id="memo" class="memo" style="display:block">
			...
			<?php if ($this->_tpl_vars['prodinfo']['prod_url'] != ""): ?>
				<a href='../product/showIndex.php?url=<?php echo $this->_tpl_vars['prodinfo']['prod_url']; ?>
'>点击查看首页</a>
			<?php else: ?>
				信息录入中...
			<?php endif; ?>
