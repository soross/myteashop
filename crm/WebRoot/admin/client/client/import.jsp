        ...
        <td>
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50%" class="STYLE1">当前位置：大客户资料导入</td>
                <td width="50%" ></td>
              </tr>
            </table>
           </td>
                      ...
                      <table width="600" border="0" cellspacing="5" cellpadding="5" class="STYLE4" >
                        ...
                        <tr>   
                           ...
                           <td>
                              ...
                              <html:option value="">--请选择客户经理--</html:option>
                              <logic:iterate id="mana" name="managers">
                                     <html:option value="${mana}">${mana}</html:option>
                               </logic:iterate>
                              </html:select>
                              * 只对高端客户（如砖石卡，非集团客户）有效
                           </td>
                           </tr>
                           <tr>
                           <td colspan="2" align="left"><html:button property="" value="导 入 文 件" onclick="sub('importExl');"></html:button></td>
                           </tr>
                      </table>
               </html:form>
            </td>
