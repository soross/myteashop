<?php /* Smarty version 2.6.26, created on 2011-07-03 13:14:32
         compiled from news/newsedit.html */ ?>
...
" <?php if ($this->_tpl_vars['info'][2] == $this->_tpl_vars['newsClassList'][$this->_sections['list']['index']]['id']): ?>selected<?php endif; ?>>
			...
			<tr>
				...
				<td>
					<input type="text" name="title" value="<?php echo $this->_tpl_vars['info'][1]; ?>
" size=50 maxlength="50">&nbsp;<font style="color: red;">*</font>
				</td>
			</tr>
			<tr>
				<td width=80>
				...
				<td>
					<input type="text" name="author" size=20 maxlength="30" value="<?php echo $this->_tpl_vars['info'][3]; ?>
">&nbsp;<font style="color: red;">*</font>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type="text" name="src" size=20 maxlength="30" value="<?php echo $this->_tpl_vars['info'][5]; ?>
">&nbsp;<font style="color: red;">*</font>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					...
					<input type="button" name="add_news" style="height:30px;"
							value="新闻修改" onclick="this.form.newsContent.value=KE.util.getData('content1');this.form.submit();">
					<input type="hidden" name="newsContent">
					<input type="hidden" name="task" value="editNews">
					<input type="hidden" name="id" value="<?php echo $this->_tpl_vars['info'][0]; ?>
">
