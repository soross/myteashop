...
<body>
	...
	<html:form action="/admin/collect?task=collectList" method="post">
	<table width="100%" border="0" align="center" cellpadding="2"
		cellspacing="1" class="tableBorder">
		<tr>
		...
		<tr>
			...
			汇总科目名称:<html:text property="collectname"  size="15" />
			</td>
			<td>
	...
	<table id="listtab" width="98%" border="0" align="center" cellpadding="3"
		...
		<tr align="center" class="thstyle">
		 ...
		 <logic:present name="collectList">
          	<logic:iterate id="collect" name="collectList">          	 
				<tr align="center" style="cursor: hand;">
					<td height=25>
						<input type="checkbox" name="phones" value="${collect.id}"
					...
					<td>
						<a href="${pageContext.request.contextPath}/admin/collect.do?task=toUpdateCollect&id=${collect.id}"><img src="${pageContext.request.contextPath}/admin/images/edit.gif" border="0">[修改]</a>
						<a href="${pageContext.request.contextPath}/admin/collect.do?task=deleteCollect&id=${collect.id}" onclick="return confirm('是否确定删除!');"><img src="${pageContext.request.contextPath}/admin/images/del.gif" border="0">[删除]</a>
					</td>
				</tr>					
	          </logic:iterate>
          </logic:present>
