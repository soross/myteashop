	...
	<body>
		<div style="text-align: center;">
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="1000" height="150">
		      ...
		      <embed src="images/top.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="1000" wmode="transparent" height="150"></embed>
    		</object>
		</div>
<div>
<div class="wrapper">
...
<div class="content clearfix page-service" id="content">
            ...
            <ul class="open-service-list clearfix">
                <li>
                    ...
                    <div class="open-service-content">
                        <a href="javascript:void(0);" class="open-service-title">厦门工商旅游学校简介</a>
                        <p class="open-service-intro">厦门工商旅游学校系厦门市政府举办、由原著名公立厦门商业学校、旅游学校、交通学校于2008年强强整合而成的首批国家级职业教育改革发展示范校、全国德育先进中职校、全国首批技能型紧缺人才培养基地。</p>
                        <p class="open-service-other" style="height:50px">
                            <a href="http://www.xmgslx.com/messageDetails.jsp?messageKey=8aef20811dd7057e011dfb8dadd80c48&categoryKey=4028808f1a27e1f6011a2814ee150229" target="_blank">详细信息</a>
                            <span class="btn-content">
                                <a href="http://www.xmgslx.com/" class="common-btn to_cloud_j"><span>网站首页</span></a>
                                <!--<span class="des">（您需要首先注册成为百度开发者）</span>-->
                            </span>
                ...
                <li>
                    <a href="javascript:void(0);" class="open-service-icon"><img src="images/service_website.png" alt="" /></a>
                    <div class="open-service-content">
                        <a href="javascript:void(0);" id="to-cloud" class="open-service-title">线上自主娱乐学习模式</a>
                        <p class="open-service-intro">线上自主娱乐学习模式是集互联网、多媒体、Web、Flash等技术开发的仿游戏模式的课程信息的网络化、游戏化。可自主学习，通过不同的关卡学到不同的课程内容，并通过线上模拟考试结合关卡的通过模式控制学生的学习进度。</p>
                        <p class="open-service-other" style="height:50px">
                        <!--<a target="_blank" href="http://developer.baidu.com/wiki/index.php?title=帮助文档首页/个人云存储_API" target="_blank">立即体验</a>-->
                        	<span class="btn-content">
                                <a href="login.html" class="common-btn to_cloud_j"><span>立即体验</span></a>
                                <!--<span class="des">（您需要首先注册成为百度开发者）</span>-->
                            </span>
                        </p>
                    </div>
    ...
    <div class="section-wrap">
        ...
        <div class="section-content">
            <ul class="open-service-list clearfix">
                <li>
                    <a href="javascript:void(0);" class="open-service-icon"><img src="images/statistics_tongji.png" alt="" /></a>
                    <div class="open-service-content">
                        <a href="javascript:void(0);" class="open-service-title">大量提升课后学习时间</a>
                        <p class="open-service-intro">随便互联网的网站，现在的学生课后上网已成为一种习惯，如果只是单纯的把课程信息展示给学生，乏味，学生的就缺乏主动性，现以动态多彩的形式展示，新颖，富有吸引力。</p>
                        <p class="open-service-other"></p>
                    </div>
                </li>
                <li>
                    <a href="javascript:void(0);" class="open-service-icon"><img src="images/b.jpg" alt="" /></a>
                    <div class="open-service-content">
                        <a href="javascript:void(0);" class="open-service-title">丰富多采的课程信息展示</a>
                        <p class="open-service-intro">随便互联网的网站，现在的学生课后上网已成为一种习惯，如果只是单纯的把课程信息展示给学生，乏味，学生的就缺乏主动性，现以动态多彩的形式展示，新颖，富有吸引力。</p>
                        <p class="open-service-other"></p>
                    </div>
                </li>
