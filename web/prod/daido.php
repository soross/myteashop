				...
				<DIV id=sdo_top_wrap>
					...
					<DIV id=Wrap>
						...
						<UL><LI><A id="ProdTypeLink" href="/web/prod/sweden.php">瑞典ASSAB系列</A>
								<LI><A id="ProdTypeLink" class=current href="/web/prod/daido.php">日本DAIDO系列</A>
								...
								<DIV class=greybg>
									<DIV class=step1Form>
										...
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/daido/rbdt_27.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/daido/rbdt_37.gif" />
										</LI>
										</UL>
										<UL>
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/daido/rbdt_47.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/daido/rbdt_57.gif" />
										</LI>
										</UL>

										<UL>
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/daido/rbdt_67.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px; height:195px;">
											<img src="/web/images/daido/rbdt_17.gif" />
										</LI>
										</UL>
										<UL>
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/daido/rbdt_07.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											&nbsp;
										</LI>
