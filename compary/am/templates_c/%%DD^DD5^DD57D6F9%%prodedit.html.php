<?php /* Smarty version 2.6.26, created on 2011-06-28 09:55:10
         compiled from product/prodedit.html */ ?>
		...
		<form id="addProd" action="action/post.php" method="post"
			...
			<table border=0 cellspacing=1 class=form>
				...
				<tr>
					...
					<td>
						<input type="text" name="prod_name" size="30" value="<?php echo $this->_tpl_vars['prodinfo'][1]; ?>
" maxlength=50 />&nbsp;<font style="color: red;">*</font>
					</td>
				</tr>
				<tr>
					<td align=center>
...
" <?php if ($this->_tpl_vars['prodinfo'][2] == $this->_tpl_vars['prodClassList'][$this->_sections['list']['index']]['id']): ?>selected<?php endif; ?>>
				...
				<tr>
					...
					<td>
						<input type="radio" name="prod_url" value="0" <?php if ('0' == $this->_tpl_vars['prodinfo'][7]): ?>checked<?php endif; ?> />未发布
			  			<input type="radio" name="prod_url" value="1" <?php if ('1' == $this->_tpl_vars['prodinfo'][7]): ?>checked<?php endif; ?>/>已发布&nbsp;<font style="color:red;">*</font>
					</td>
				</tr>
				<tr>
					<td align=center>
					...
					<td>
						<table cellpadding="0" cellspacing="0">
							<tr>
								...
								<td>
									<img id="previewImg" name="previewImg" src="../../product/images/<?php echo $this->_tpl_vars['prodinfo'][3]; ?>
"
...
unset($_smarty_tpl_vars);
 ?>
				...
				<tr>
					...
					<td>
						<input type="text" name="prod_link" value="<?php echo $this->_tpl_vars['prodinfo'][5]; ?>
" size="30" />
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="compary" value="<?php echo $this->_tpl_vars['prodinfo'][6]; ?>
" size="30" />
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						<input type="button" name="add_prod" style="height:30px;"
							value="产品修改" onclick="this.form.prodDesc.value=KE.util.getData('content1');this.form.submit();">
						<input type="hidden" name="task" value="editProduct">
						<input type="hidden" name="prodDesc">
						<input type="hidden" name="id" value="<?php echo $this->_tpl_vars['prodinfo'][0]; ?>
">
						<input type="hidden" name="path" value="<?php echo $this->_tpl_vars['prodinfo'][3]; ?>
">
