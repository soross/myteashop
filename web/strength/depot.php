							...
							<DIV class=IndexDo><!--左边菜单部分开始-->
								...
								<DL>
									<DD class=open>
										<H6>实力展示</H6>
						<UL>
						<LI><A class=current href="/web/strength/depot.php">仓库展示</A>
						<LI><A href="/web/strength/produce.php">生产设备展示</A>
						<LI><A href="/web/strength/working.php">加工设备展示</A>
						</LI></UL>
						...
						<DIV class=cntBox_right>
							<DIV class=cntBox_left>
								<DIV class=greybg>
									<DIV class=step1Form>
									   <UL>
										<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;金华洲模具钢材有限公司拥有充足的仓储能力，拥有5千平方米的大型彩钢结构的室内仓库和一万平方米的室外仓库，对充足的库存资源进行电脑化管理，以迅速准确的服务来满足不同层次客户的要求。</p>
									   </UL>
									   <UL>
									   	&nbsp;<br>
									   	<img src="/web/images/strength/1.jpg">
									   </UL>
									   <UL>
									   	&nbsp;<br>
									   	<img src="/web/images/strength/2.jpg">
									   </UL>
									   <UL>
									   	&nbsp;<br>
									   	<img src="/web/images/strength/3.jpg">
									   	<br>&nbsp;
									   </UL>
									</DIV>
								</DIV>
