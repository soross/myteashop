<?php /* Smarty version 2.6.26, created on 2011-06-27 02:51:06
         compiled from job/joblist.html */ ?>
...
<div id='pdv_15183' class='pdv_class'  title='职位查询' style='width:740px;height:279px;top:77px;left:244px; z-index:12'>
<div id='spdv_15183' class='pdv_content' style='overflow:visible;width:100%;'>
...
$this->_sections['list']['loop'] = is_array($_loop=$this->_tpl_vars['jobRow']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
<li>
	<div class="bt"><a href="<?php echo $this->_tpl_vars['jobRow'][$this->_sections['list']['index']]['job_info_url']; ?>
" target="_blank" ><?php echo $this->_tpl_vars['jobRow'][$this->_sections['list']['index']]['job_name']; ?>
</a></div>
	<div class="cl"><a href="<?php echo $this->_tpl_vars['jobRow'][$this->_sections['list']['index']]['job_info_url']; ?>
" target="_blank" >详情</a></div>
	<div class="au"><?php echo $this->_tpl_vars['jobRow'][$this->_sections['list']['index']]['recruiting_numbers']; ?>
</div>
	<div class="bk"><?php echo $this->_tpl_vars['jobRow'][$this->_sections['list']['index']]['working_location']; ?>
</div>
</li>
<?php endfor; endif; ?>
