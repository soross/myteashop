<?php /* Smarty version 2.6.26, created on 2011-06-27 08:07:51
         compiled from job/jobinfo.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'job/jobinfo.html', 309, false),)), $this); ?>
...
<div id='pdv_15181' class='pdv_class'  title='栏目导航' style='width:207px;height:187px;top:0px;left:0px; z-index:9'>
<div id='spdv_15181' class='pdv_content' style='overflow:visible;width:100%;'>
...
<div style="height:48px;border:0px;padding:0;margin:0;background:url(../images/title_lmdh.gif) no-repeat">
	...
	<div style="float:right;width:20px;height:48px;background:url(../mages/title_lmdh.gif) -880px 0px no-repeat;"></div>
</div>
...
<a href="joblist.php" target="_self" class="titlemenu_dolphin">诚聘英才</a>
...
<div id='pdv_15182' class='pdv_class'  title='当前位置' style='width:763px;height:47px;top:0px;left:239px; z-index:11'>
<div id='spdv_15182' class='pdv_content' style='overflow:hidden;width:100%;height:100%'>
...
<div id='pdv_15197' class='pdv_class'  title='应聘申请' style='width:740px;height:829px;top:498px;left:244px; z-index:14'>
<div id='spdv_15197' class='pdv_content' style='overflow:visible;width:100%;'>
...
<link href="../css/jobform.css" rel="stylesheet" type="text/css" />
<script language="javascript" src="../js/jobform.js"></script>
<div  id="notice" class="noticediv"></div>
<form id="jobform" method="post" action="action/commit.php" name="jobform">
<table width="100%" border="0" cellspacing="0" cellpadding="3" >

<tr>
      <td width="80" align="right">姓　　名：</td>
      <td>
        <input type="text" name="title" maxlength="20" class="input" style="width:200px" />
...
<tr>
      ...
      <td>
        <input type="text" name="name"  maxlength="10" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div>  </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <select name="custom1" >
		<option value="0" >未婚</option><option value="1" >已婚</option>
        </select>
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
...
<tr>
      ...
      <td>
        <input type="text" name="company"  maxlength="50" class="input" style="width:300px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div>  </td>
    </tr>

<tr>
      <td width="80" align="right">最高学历：</td>
      <td>
        <input type="text" name="company_address"  maxlength="20" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div>  </td>
    </tr>

<tr>
      <td width="80" align="right">毕业专业：</td>
      <td>
        <input type="text" name="products_id" maxlength="30" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div>  </td>
    </tr>
...
<tr>
      ...
      <td>
        <input type="text" name="products_name" maxlength="10" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div>  </td>
    </tr>
...
<tr>
      ...
      <td>
        <input type="text" name="tel" maxlength="20" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div>  </td>
    </tr>
...
<tr>
      ...
      <td>
        <input type="text" name="fax" maxlength="20" class="input" style="width:200px" />
         <div style="padding-top:3px;color:#666"></div>  </td>
    </tr>

<tr>
      <td width="80" align="right">通信地址：</td>
      <td>
        <input type="text" name="address" maxlength="100" class="input" style="width:300px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div>  </td>
    </tr>
...
<tr>
      ...
      <td>
        <input type="text" name="email" maxlength="50" class="input" style="width:300px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div>  </td>
    </tr>
...
<tr>
      ...
      <td>
        <input type="text" name="products_num" maxlength="250" class="input" style="width:399px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div>  </td>
    </tr>

    <tr>
      <td width="80" align="right">教育经历：</td>
      <td>
    ...
    <tr>
      <td width="80" align="right">工作经历：</td>
      <td>
...
<input type="text" name="ImgCode" style="width:39px" maxlength="4"  class="input" />
</div>
...
<span id="getImgCode" style="cursor:pointer;margin-left:10px;line-height:20px">看不清？更换一张</span>
    ...
    <tr>
      ...
      <td height="30">
        ...
        <input name='jobid' type='hidden' id="jobid" value='4'>
	  </td>
    </tr>
  </table>
</form>
...
<div id='pdv_15196' class='pdv_class'  title='职位信息' style='width:740px;height:411px;top:77px;left:244px; z-index:15'>
<div id='spdv_15196' class='pdv_content' style='overflow:visible;width:100%;'>
<div class="pdv_border" style="margin:0;padding:0;height:100%;border:0px  solid;background:;">
...
<link href="../css/jobcontent.css" rel="stylesheet" type="text/css" />
<div id="jobcontent">

	<div class="jobitem">
	职位名称：【<span style="color:#FF6600;"><strong><?php echo $this->_tpl_vars['jobinfo']['job_name']; ?>
</strong></span>】<br />
	职位类型：<?php if ($this->_tpl_vars['jobinfo']['job_type'] == '0'): ?>全职<?php else: ?><?php if ($this->_tpl_vars['jobinfo']['job_type'] == '1'): ?>兼职<?php else: ?>其他<?php endif; ?><?php endif; ?><br />
	工作经验：<?php echo $this->_tpl_vars['jobinfo']['work_experience']; ?>
年以上<br />
	学历要求：<?php if ($this->_tpl_vars['jobinfo']['degree'] == '1'): ?>高中<?php endif; ?><?php if ($this->_tpl_vars['jobinfo']['degree'] == '2'): ?>大专<?php endif; ?><?php if ($this->_tpl_vars['jobinfo']['degree'] == '3'): ?>本科<?php endif; ?><?php if ($this->_tpl_vars['jobinfo']['degree'] == '4'): ?>研究生<?php endif; ?><?php if ($this->_tpl_vars['jobinfo']['degree'] == '5'): ?>不限<?php endif; ?><br />
	招聘人数：<?php echo $this->_tpl_vars['jobinfo']['recruiting_numbers']; ?>
名<br />
	发布时间：<?php echo ((is_array($_tmp=$this->_tpl_vars['jobinfo']['create_date'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 10, "") : smarty_modifier_truncate($_tmp, 10, "")); ?>
<br />
  ...
  <div class="jobintro">
  <?php echo $this->_tpl_vars['jobinfo']['job_desc']; ?>
  ...
  <div class="jobintro">
  <?php echo $this->_tpl_vars['jobinfo']['rec_req']; ?>

  </div>

	<div class="jobcontact">
	联 系 人：<?php echo $this->_tpl_vars['jobinfo']['link_name']; ?>
<br />
	联系电话：<?php echo $this->_tpl_vars['jobinfo']['link_phone']; ?>
<br />
	电子邮件：<?php echo $this->_tpl_vars['jobinfo']['link_email']; ?>
<br />
	</div>
</div>
