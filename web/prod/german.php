				...
				<DIV id=sdo_top_wrap>
					...
					<DIV id=Wrap>
						...
						<UL><LI><A id="ProdTypeLink" href="/web/prod/sweden.php">瑞典ASSAB系列</A>
								...
								<LI><A id="ProdTypeLink" class=current href="/web/prod/german.php">德国SAARSTAHL系列</A>
								...
								<DIV class=greybg>
									<DIV class=step1Form>
										...
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/saarstah/sbt_07.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/saarstah/sbt_09.gif" />
										</LI>
										</UL>
										<UL>
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/saarstah/sbt_17.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/saarstah/sbt_19.gif" />
										</LI>
										</UL>
										<UL>
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/saarstah/sbt_27.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/saarstah/sbt_29.gif" />
										</LI>
										</UL>
										<UL>
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/saarstah/sbt_42.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/saarstah/sbt_44.gif" />
										</LI>
										</UL>
										<UL>
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/saarstah/sbt_52.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/saarstah/sbt_54.gif" />
										</LI>
										</UL>
										<UL>
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/saarstah/sbt_62.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/saarstah/sbt_64.gif" />
										</LI>
										</UL>
									</DIV>
								</DIV>
