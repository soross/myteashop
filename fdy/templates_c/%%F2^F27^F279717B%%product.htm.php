<?php /* Smarty version 2.6.26, created on 2012-02-26 05:21:36
         compiled from product.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'product.htm', 21, false),)), $this); ?>
...
<div class="Hs_Middle">
	<!--内页动画-->
    <div class="PageBanner"><img width="1010" height="170" src="<?php echo $this->_tpl_vars['sol']['picture']; ?>
"></div>
    <!--内页动画 结束-->
    <!--左区域-->
    <div class="Page_left">
    	<div class="Page_Text">
    	<div class="Page_Title"><span style="font-size:18px;font-family:'微软雅黑';color:#ff7c00;">产品销售</span></div>
    		<?php echo $this->_tpl_vars['sol']['desc']; ?>
</div>
    		<hr>
...
?>
			<div class="Products">
	        	<a href="product_<?php echo $this->_tpl_vars['solList'][$this->_sections['list']['index']]['id']; ?>
_info.html" class="Products_Img">
	        	<img width="165" height="118" src="<?php echo $this->_tpl_vars['solList'][$this->_sections['list']['index']]['picture']; ?>
"></a>
	            <a href="product_<?php echo $this->_tpl_vars['solList'][$this->_sections['list']['index']]['id']; ?>
_info.html"><b><?php echo $this->_tpl_vars['solList'][$this->_sections['list']['index']]['name']; ?>
</b><br>
			...
			<!--维修-->
	        <div class="Page_Text">
		    	<div class="Page_Title"><span style="font-size:18px;font-family:'微软雅黑';color:#ff7c00;">备件销售与维修</span></div>
		       <?php echo $this->_tpl_vars['sol']['desc2']; ?>
 </div>
<hr>
			<?php unset($this->_sections['list']);
$this->_sections['list']['name'] = 'list';
$this->_sections['list']['loop'] = is_array($_loop=$this->_tpl_vars['solList2']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['list']['show'] = true;
$this->_sections['list']['max'] = $this->_sections['list']['loop'];
$this->_sections['list']['step'] = 1;
$this->_sections['list']['start'] = $this->_sections['list']['step'] > 0 ? 0 : $this->_sections['list']['loop']-1;
...
?>
			<div class="Products">
	        	<a href="product_<?php echo $this->_tpl_vars['solList2'][$this->_sections['list']['index']]['id']; ?>
_info.html" class="Products_Img">
	        	<img width="165" height="118" src="<?php echo $this->_tpl_vars['solList2'][$this->_sections['list']['index']]['picture']; ?>
"></a>
	            <a href="product_<?php echo $this->_tpl_vars['solList'][$this->_sections['list']['index']]['id']; ?>
_info.html"><b><?php echo $this->_tpl_vars['solList2'][$this->_sections['list']['index']]['name']; ?>
</b><br>
				<?php echo ((is_array($_tmp=$this->_tpl_vars['solList2'][$this->_sections['list']['index']]['desc'])) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)); ?>
		</a>
	        </div>
