				...
				<DIV id=sdo_top_wrap>
					...
					<DIV id=Wrap>
						...
						<UL><LI><A id="ProdTypeLink" href="/web/prod/sweden.php">瑞典ASSAB系列</A>
								...
								<LI><A id="ProdTypeLink" class=current href="/web/prod/copper.php">铜类</A>
								</LI></UL>
								...
								<DIV class=greybg>
									<DIV class=step1Form>
										...
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/other/other_02.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/other/other_04.gif" />
										</LI>
										</UL>
										<UL>
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/other/other_12.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/other/other_14.gif" />
										</LI>
										</UL>
										<UL>
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/other/other_22.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/other/other_24.gif" />
										</LI>
										</UL>
									</DIV>
								</DIV>
