	...
	<html:form action="/admin/unit" method="post">
		...
		<table width="100%" border="0" align="center" cellspacing="1"
			...
			<tr>
				...
				<td colspan="3">
					<html:select property="unitFlag" style="width:100px">
			...
			<tr>
				...
				<td colspan="3">
					<html:text property="code"  size="30"  styleId="txt"></html:text>
				</td>
			</tr>
			<tr>
				<td align="right">
				...
				<td colspan="3">
					<html:text property="unitName"  size="30"  styleId="txt"></html:text>
				</td>
			</tr>
			<tr>
				<td align="right">
			...
			<tr>
				...
				<td colspan="3">
					<html:text property="phone"  size="30"  styleId="txt"></html:text>
				</td>
			</tr>
			<tr>
				<td align="right">
			...
			<tr>
				<td colspan="4" align="right" class="tdpage">
					<input type="hidden" name="task" value="addUnit">
