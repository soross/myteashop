<?php /* Smarty version 2.6.26, created on 2011-07-03 15:49:33
         compiled from aboutus/company.html */ ?>
...
<div style="margin:0px 1px 0px;padding:0px;">
<div style="MARGIN-TOP: 15px; PADDING-BOTTOM: 20px; MARGIN-LEFT: 15px; COLOR: #333; LINE-HEIGHT: 150%">
...
<div id='pagecontent' class='page_content'><img style="PADDING-RIGHT: 15px; FLOAT: left" alt="" src="../images/201003111268297027593.gif" border=0 /><?php echo $this->_tpl_vars['companyInfo']; ?>
 </div>
<?php echo '
<script>
