// Ver: 4.1
var nOP=0,nOP5=0,nIE=0,nIE4=null,nIE5=0,nNN=0,nNN4=0,nNN6=0,nMAC=0,nIEM=0,nIEW=0,nDM=0,nVER=0.0,st_delb=0,st_addb=0,st_reg=1;stnav();var st_ttb=nIE||nOP&&(nVER>=6&&nVER<7);
...
function stgcur(i)
{
	if(nNN6)
		return "default";
	return i.ityp!=6&&((i.ppi==0&&stgme(i).mcks&&stgsub(i))||i.iurl) ? "pointer" : "default";
}
function stgiws(o)
{
	if(stgpar(o).pver)
