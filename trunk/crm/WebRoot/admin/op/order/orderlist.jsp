...
<body>
	...
	<table width="100%" border="0" align="center" cellpadding="2"
		...
		<tr>
			...
			预约时间:	<html:text property="order"  size="15"  />
			</td>
			<td width="20%" height=25 class="pl20">
			电话:<html:text property="mobile"  size="15" />
			</td>
			<td>
		...
		<logic:present name="orderList">
			...
			<logic:iterate id="order" name="orderList">
					<tr align="center">
						...
						<td>
							<a href="${pageContext.request.contextPath}/admin/order.do?task=toUpdateOrder&id=${order.id}"><img src="${pageContext.request.contextPath}/admin/images/edit.gif" border="0">[修改]</a>&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/admin/order.do?task=deleteOrder&id=${order.id}" onclick="return confirm('是否确定删除!');"><img src="${pageContext.request.contextPath}/admin/images/del.gif" border="0">[删除]</a>
						</td>
					</tr>
			</logic:iterate>
		</logic:present>
