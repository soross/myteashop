...
/**
 *  <div id="page">
       <span class="page_detail">共<span class="pageTotal">20</span>条&nbsp;&nbsp;每页<span class="pagePer">10</span>条&nbsp;&nbsp;页次：<span class="pageTime">2/2</span></span>
       <span class="page">
       	   <a class="pageHome" href="#">首页</a>
           <a class="pagePrev" href="#">上一页</a>
           <a class="pageNo" href="#">1</a>
           <a class="pageCurrent" href="#">2</a>
           <a class="pageNext" href="#">下一页</a>
           <a class="pageEnd" href="#">尾页</a>
       </span>
   </div>
 */
...
//开始分页导航条代码：
$pagenav = "<div id='page'>
       <span class='page_detail'>共<span class='pageTotal'>".$totle."</span>条&nbsp;&nbsp;每页<span class='pagePer'>".$displaypg."</span>条&nbsp;&nbsp;页次：<span class='pageTime'>".$page."/".$lastpg."</span></span>
			<span class='page'>";

if($page==1){
	$pagenav = $pagenav."<a class=pageHome href='#'>首页</a><a href='#' class=pagePrev>上一页</a>";

}else{
	$pagenav = $pagenav."
					<A class=pageHome href='$url=1'>首页</A>
				    <a clas=pagePrev href='$url=$prepg'>上一页</a>";
}
...
if($page== $lastpg){
	$pagenav = $pagenav."<a class=pageNext href='#'>下一页</a>";

}else{
	$pagenav = $pagenav."<a class='pageNext' href='".$url."=".($page+1)."'>下一页</a>";
}
/**
...
**/
if($page== $lastpg){
	$pagenav = $pagenav."<a class=pageEnd href='#'>尾页</a>";
}else{
	$pagenav = $pagenav."<A class='pageEnd' href='$url=$lastpg'>尾页</A>";
}
$pagenav = $pagenav."
		</span>
	</DIV>";
