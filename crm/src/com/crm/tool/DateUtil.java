...
public class DateUtil {
	...
	public static String DateToStringBy_YMDHMS(Date date, String type){
		String str = new SimpleDateFormat(type).format(date);
		return str;
	}
	
	public static Date StringToDate_YMDHMS(String date, String type){
		Date newDate = null;
		try {
			newDate = (new SimpleDateFormat(type).parse(date));
		} catch (ParseException e) {
			newDate = new Date();
			e.printStackTrace();
		}
