...
<head>
	...
	<script>
		...
		function checkManager(){
			...
			var manger=document.getElementById("manager").value;
			if(manger.length>0){
			           b = true;
		...
		var form =document.all.form2;
	     ...
	     form.action="${pageContext.request.contextPath}/admin/groupDistribute.do?task=noDistributeList";
		form.submit();
										...
										<td height="20" bgcolor="#FFFFFF" colspan="8" class="STYLE1">
											<div align="center">
												...
												<logic:present name="manageList">
													...
													<input type="hidden" name="task" value="distributeManage">
