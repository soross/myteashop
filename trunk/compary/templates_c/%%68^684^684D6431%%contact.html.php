...
<div id='pdv_14987' class='pdv_class'  title='方案类型' style='width:209px;height:218px;top:197px;left:0px; z-index:10'>
...
<div style="height:48px;border:0px;padding:0;margin:0;background:url(../images/title_link.gif) no-repeat">
	<div style="float:left;width:120px;height:38px;font:12px/46px simsun;color:#464646;padding-top:4px;padding-left:38px;">方案类型</div>
