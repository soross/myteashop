...
if (is_uploaded_file($_FILES["upfile"][tmp_name])){
	...
	$destination_folder="../../../product/images/"; //上传文件路径
...
function getProdCode($db,$prodClass,$prodId){
	$query = $db->query("select ename from prod_class where id='".$prodClass."'");
	$row=$db->fetch_array($query);
	$ename = $row[ename]."-";
	$prodCode=$ename.date("Ymd",time())."-".$prodId;
	return $prodCode;
}
?>
