						...
						<td>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="1"
								...
								<tr>
									...
									<td width="3%" height="22" bgcolor="#FFFFFF" class="STYLE1"
										align="left" background="${pageContext.request.contextPath}/admin/images/bg.gif">
										<div align="left">
											<span class="STYLE1">话费信息</span>
										</div>
									</td>
									<td width="3%" height="22" bgcolor="#FFFFFF" class="STYLE1"
										align="left">
								...
								<logic:present name="feelist">

									<logic:iterate id="fee" name="feelist">
										...
										<tr>
											<td width="3%" height="22" bgcolor="#FFFFFF" class="STYLE1"
												...
												<div align="center">
													...
													<fmt:formatDate value="${fee.feedate}" pattern="yyyyMM"/>
											...
											<td width="3%" height="22" bgcolor="#FFFFFF" class="STYLE1"
												align="center" colspan="2">
												<div align="center">
													<span class="STYLE1">${fee.phone }</span>
												</div>
											</td>
											<td width="3%" height="22" bgcolor="#FFFFFF" class="STYLE1"
												align="center" colspan="2">
												<div align="center">
													<span class="STYLE1">${fee.fullfee }</span>
												</div>
											</td>
											<td width="3%" height="22" bgcolor="#FFFFFF" class="STYLE1"
												align="center" colspan="2">
												<div align="center">
													<span class="STYLE1">${fee.arrearage}</span>
												</div>
											</td>
										</tr>
									</logic:iterate>
