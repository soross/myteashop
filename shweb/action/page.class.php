...
function pageft($totle,$displaypg=20,$url='',$param=''){
...
if($url_query){
	...
	if ($pos === false) {
	    if($url_query) $url.="&".$param."&page"; else $url.=$param."&page";
	} else {
...
//开始分页导航条代码：
$pagenav = "
<DIV id=pagesinfo>共<span>". $totle."</span>条 每页<span>". $displaypg ."</span>条 页次：<span>". $page ."</span>/<span>".$lastpg."</span></DIV>
		<DIV id=pages>
			<UL>";
