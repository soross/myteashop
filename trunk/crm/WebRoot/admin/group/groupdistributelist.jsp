								...
								<tr>
									<td width="46%" valign="middle">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<logic:equal name="user" property="userid" value="admin">
												...
												<td class="STYLE1" align="right">
													<img
														...
														width="14" height="14" />
													<a
														href="${pageContext.request.contextPath}/admin/groupDistribute.do?task=noDistributeList">集团分配</a>
													<img
														src="${pageContext.request.contextPath}/admin/images/33.gif"
														width="14" height="14" />
													<a
														href="${pageContext.request.contextPath}/admin/groupDistribute.do?task=hasDistributeList">集团调配</a>
											...
											<b>${user.userid }你好！调配与分配只限系统管理员，谢谢！</b>
