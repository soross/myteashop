...
<head>
    ...
    function allot(){//分配客户
        ...
        for(var i=0;i<chks.length;i++){
         ...
         var url="${pageContext.request.contextPath}/admin/client.do?task=deploy&manager="+manager+"&"+ids;
        ...
        <td>
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50%" class="STYLE1">当前位置：大客户经理调配</td>
                <td width="50%" ></td>
              </tr>
            </table>
           </td>
      ...
      <tr>
        ...
        <td>
          ...
          <tr>
            ...
            <td width="3%" height="22" background="${pageContext.request.contextPath}/admin/images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">三个月话费</span></div></td>
            <td width="4%" height="22" background="${pageContext.request.contextPath}/admin/images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">当前剩余积分</span></div></td>
                  ...
                  <tr>
                   <td width="10%" class="STYLE1" bgcolor="#FFFFFF">
                    ...
                    <select id="mana" name="manager" >
                     ...
                     <html:button property="" value="调 配" onclick="allot();">
                      </html:button>
                    </td>
                  </tr>
                </table>
