...
if(mm<10)mm="0"+mm;
var dd = event.srcElement.innerText;
if(dd<10)dd="0"+dd;
sDate = document.all.Year.value + "-" + mm + "-" + dd;
...
//下面开始输出日历表格(border-color:#0066FF 06527d)
...
for (intLoop = thisyear - 60; intLoop < (thisyear + 1); intLoop++)
