        ...
        <td>
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50%" class="STYLE1">当前位置：[积分消费]-[兑换礼品]</td>
                <td width="50%" ></td>
              </tr>
            </table>
           </td>
    ...
    <td>
       <table width="100%" border="0" cellspacing="0" cellpadding="0">
         <tr>
            ...
            <td align="center" >
            <br>
               <html:form action="/admin/present">
                 <input type="hidden" name="task" value="toBuy"/>
                  <table width="520"  class="STYLE1" cellpadding="0" cellspacing="0" style="vertical-align: middle">
                     <tr>
      ...
      <tr>
        ...
        <td>
           <table width="100%" border="0" cellpadding="0" cellspacing="0"  >
              <tr>
                 <td width="200" valign="top" bgcolor="#FFFBF0"> <jsp:include page="clientinfo.jsp"></jsp:include></td>
                 <td>
                 <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" >
          <tr>
             <td width="3%" height="22" background="${pageContext.request.contextPath}/admin/images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">图片</span></div></td>
         ...
         <logic:present name="presentList">
          <logic:empty name="presentList">
              <tr>
                 <td height="20" bgcolor="#FFFFFF" colspan="7" class="STYLE4" align="center"> 暂无任何礼品！</td>
              </tr>
          </logic:empty>
        <logic:iterate id="present" name="presentList" >
           <logic:greaterEqual value="1" name="present" property="num">
          <tr>
            <td height="50"  bgcolor="#FFFFFF">
            <div align="center">
              <span class="STYLE1" >
                  <logic:empty  name="present"  property="picture">
                  <img id="previewImg" src="${pageContext.request.contextPath}/images/I3GWAY9WYB_104_120_120.gif" style="cursor: hand;width:80px;height:50px" onclick="window.open(this.src);" width="150" height="150" alt="点击查看大图"/>
                </logic:empty>
                <logic:notEmpty name="present"  property="picture">
                 <img id="previewImg" src="${pageContext.request.contextPath}/admin/upload/${present.picture}" style="cursor: hand;width:80px;height:50px" onclick="window.open(this.src);" width="150" height="150" alt="点击查看大图"/>
                </logic:notEmpty>
               </span></div></td>
            ...
            <td bgcolor="#FFFFFF" align="center" class="STYLE1">
                 <a href="${pageContext.request.contextPath}/admin/score.do?task=change&presentId=${present.id}">[兑 换]</a>
            </td>
          </tr>
          </logic:greaterEqual>
        </logic:iterate>
