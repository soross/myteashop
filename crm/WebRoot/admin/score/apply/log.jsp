        ...
        <td>
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50%" class="STYLE1">当前位置：积分日志查询</td>
                <td width="50%" ></td>
              </tr>
            </table>
           </td>
    ...
    <td>
       <table width="100%" border="0" cellspacing="0" cellpadding="0">
         <tr>
            ...
            <td align="center" >
              <br>
               <html:form action="/admin/score?task=searchLog">
      ...
      <tr>
        ...
        <td>
          ...
          <tr>
            ...
            <td width="12%" height="22" background="${pageContext.request.contextPath}/admin/images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">操作前积分</span></div></td>
            <td width="10%" height="22" background="${pageContext.request.contextPath}/admin/images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">操作后积分</span></div></td>
            <td width="8%" height="22" background="${pageContext.request.contextPath}/admin/images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">操作类型</span></div></td>
            <td width="14%" height="22" background="${pageContext.request.contextPath}/admin/images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">操作时间</span></div></td>
          <td width="10%" height="22" background="${pageContext.request.contextPath}/admin/images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">操作员</span></div></td>
          </tr>
          <logic:present name="logList">
          <logic:empty name="logList">
              <tr>
                 <td height="20" bgcolor="#FFFFFF" colspan="6" align="center" class="STYLE1"> 暂无任何记录！</td>
              </tr>
          </logic:empty>
          <logic:iterate id="log" name="logList" >
          <tr>
            <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${log.phone}</span></div></td>
            <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${log.beforescore} </span></div></td>
            <td bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${log.afterscore}</span></div></td>
            <td bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">
              <logic:equal value="0" name="log" property="opertype">
                  礼品兑换
              </logic:equal>
              <logic:equal value="1" name="log" property="opertype">
                礼品回退
              </logic:equal>
             </span></div></td>
            <td bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">
            <bean:write format="yyyy-MM-dd HH:mm:ss" name="log" property="operdate"/>
            </span></div></td>
            <td bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${log.operater}</span></div></td>
          </tr>
          </logic:iterate>
          </logic:present>
        </table></td>
