<?php /* Smarty version 2.6.26, created on 2011-11-18 09:51:05
	...
	<div id="editor" class="column column520">
		...
		<div id="galleryList" class="showinfo">
		    ...
		    <div id="maintext" class="maintext">
		    	<div style="background:#ececec;"><h1 style="padding:5px 0 5px 5px;"><?php echo $this->_tpl_vars['lang_company']['GongSiWenHua']; ?>
</h1></div>
