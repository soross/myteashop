...
<body>
	...
	<html:form action="/admin/role?task=addRole" method="post">
		<table width="100%" border="0" align="center" cellspacing="1"
			...
			<tr>
				...
				<td colspan="3">
					<html:text property="rolename"/><span id="uid"></span>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="4" align="right" class="tdpage">
					<input type="hidden" value="330" name="modfunid">
					<input type="reset" name="reset" value=" 重 置 " class="inputs" />
					<input type="submit" name="submit" value=" 新增角色 " class="inputs" />
				</td>
			</tr>
		</table>
	</html:form>
