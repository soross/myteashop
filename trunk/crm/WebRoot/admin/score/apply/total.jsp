        ...
        <td>
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50%" class="STYLE1">当前位置：总积分查询</td>
                <td width="50%" ></td>
              </tr>
            </table>
           </td>
            <td width="54%"><table border="0" align="right" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="220">
                  ...
                  <tr>
                    <td class="STYLE1"><div align="center"><a href="${pageContext.request.contextPath}/admin/score.do?task=searchMonth">【月度积分查询】</a></div></td>
    ...
    <td>
       <table width="100%" border="0" cellspacing="0" cellpadding="0">
         <tr>
            ...
            <td align="center" >
              <br>
               <html:form action="/admin/score?task=searchTotal">
      ...
      <tr>
        ...
        <td>
          ...
          <tr>
            ...
            <td width="12%" height="22" background="${pageContext.request.contextPath}/admin/images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">积分起始时间</span></div></td>
            <td width="14%" height="22" background="${pageContext.request.contextPath}/admin/images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">当前可用积分</span></div></td>
            <td width="12%" height="22" background="${pageContext.request.contextPath}/admin/images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">总消费积分</span></div></td>
            <td width="14%" height="22" background="${pageContext.request.contextPath}/admin/images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">累计积分</span></div></td>
          </tr>
          <logic:present name="totalList">
          <logic:empty name="totalList">
              <tr>
                 <td height="20" bgcolor="#FFFFFF" colspan="7" align="center" class="STYLE1"> 暂无任何礼品！</td>
              </tr>
          </logic:empty>
          <logic:iterate id="total" name="totalList" >
          <tr>
            <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${total.phone}</span></div></td>
            <td height="20" bgcolor="#FFFFFF">
            <div align="center"><span class="STYLE1">
            <bean:write format="yyyy-MM-dd HH:mm:ss" name="total" property="invalidate"/>
            </span></div></td>
            <td bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${total.vintegral }</span></div></td>
            <td bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${total.invalible }</span></div></td>
            <td bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${total.total }</span></div></td>
          </tr>
          </logic:iterate>
          </logic:present>
        </table></td>
