	...
	<html:form action="/admin/staff" method="post" onsubmit="return check();">
		...
		<table width="100%" border="0" align="center" cellspacing="1"
			...
			<tr>
				...
				<td>
					<html:text property="birthday"  maxlength="15" onfocus="javascript:WdatePicker({dateFmt:'yyyy-MM-dd'});"
			...
			<tr>
				<td colspan="4" align="right" class="tdpage">
					<input type="hidden" name="task" id="task" value="addStaff">
					<input type="hidden" value="382" name="modfunid">
