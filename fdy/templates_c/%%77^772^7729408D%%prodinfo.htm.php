<?php /* Smarty version 2.6.26, created on 2012-02-26 05:21:29
         compiled from prodinfo.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'prodinfo.htm', 29, false),)), $this); ?>
...
"></div>
    ...
    <div class="Page_left">
		...
		<div class="Page_Text"  style="margin-bottom: -20px;">
    		<div class="Page_Title"><span style="font-size:18px;font-family:'微软雅黑';color:#ff7c00;"><?php if ($this->_tpl_vars['solution']['type'] == 'SP'): ?>其他配件<?php else: ?>其他产品<?php endif; ?></span></div>
 		 </div>
    		<hr>
