...
<body>
	...
	<html:form action="/admin/staff?task=updateStaff" method="post" onsubmit="return check();">
		...
		<table width="100%" border="0" align="center" cellspacing="1"
			...
			<tr>
				<td colspan="4" align="right" class="tdpage">
					...
					<input type="hidden" value="383" name="modfunid">
					<input type="reset" name="reset" value=" 重 置 " class="inputs" />
					<input type="button" name="button" value=" 返 回 " class="inputs" onclick="javascript:history.back();"/>
