...
$db=new mysql("localhost", "root", "root", "compary", ALL_PS, "GBK");
//$db=new mysql("localhost", "gugunet", "ggn~908.705070", "gugunet", ALL_PS, "GBK");
//echo $db->getFileName("13","./",strlen("news")+1)
//echo $db->cn_substr('阿德斯夫妇斯蒂芬斯蒂芬',0,10);
?>
