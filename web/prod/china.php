						...
						<DIV id=Container>
							<DIV class=IndexDo><!--左边菜单部分开始-->
								...
								<DL>
									<DD class=open>
										<H6>产品列表</H6>
						<UL><LI><A id="ProdTypeLink" href="/web/prod/sweden.php">瑞典ASSAB系列</A>
								...
								<LI><A id="ProdTypeLink" class=current href="/web/prod/china.php">国产优质特钢系列</A>
								...
								<DIV class=greybg>
									<DIV class=step1Form>
										...
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/china/china1.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/china/china2.gif" />
										</LI>
										</UL>
										<UL>
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/china/china3.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/china/china4.gif" />
										</LI>
										</UL>
										<UL>
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/china/china5.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/china/china6.gif" />
										</LI>
										</UL>
										<UL>
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/china/china7.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/china/china8.gif" />
										</LI>
										</UL>
										<UL>
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/china/china9.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/china/china10.gif" />
										</LI>
										</UL>
										<UL>
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/china/china11.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/china/china12.gif" />
										</LI>
										</UL>
										<UL>
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/china/china13.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/china/china14.gif" />
										</LI>
										</UL>
										<UL>
										<LI style="WIDTH: 50%; float:left;padding-bottom:10px;">
											<img src="/web/images/china/china15.gif" />
										</LI>
										<LI  style="float:left;padding-bottom:10px;">
											<img src="/web/images/china/china16.gif" />
										</LI>
										</UL>
									</DIV>
								</DIV>
