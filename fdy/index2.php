			...
			<div id="banner">
				<div class="nybanner">
					<div class="nybanner_mainer">
						<div class="hdp" id="idTransformView">
							  <ul class="slider" id="idSlider">
								<li><img src="images/siteConfig9_201052112622.jpg"/></li>
								<li><img src="images/siteConfig9_2010221201512.jpg"/></li>
								<li><img src="images/siteConfig9_2010221201658.jpg"/></li>
							  </ul>
