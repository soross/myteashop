...
//开始分页导航条代码：
$pagenav = "
<DIV id=pagesinfo>共". $displaypg ."/". $totle."条&nbsp;页次：". $page ."/".$lastpg."</DIV>
		<DIV id=pages>
			<UL>";
...
$pagenav = $pagenav."<LI class=opt><SELECT style='width:60px;' onchange='if(-1!=this.value)location.href=\"".$url."=\"+this.value;'>";
for($i=1; $i<$lastpg +1 ;$i++){
	if($page == $i){
