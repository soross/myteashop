	...
	<form action="action_admin_prod_edit.php" method="post" onsubmit="syncTextarea()" enctype="multipart/form-data">
    	<tr >
       	...
       	<tr>
  			...
  			<td>
  				<input type="text" name="src_price" size=10 value="<?php echo $row_prod[src_price]?>"> 元<font style="color:red;">*</font>
			</td>
		...
		<tr>
  			...
  			<td>
  				<input type="text" name="new_price" size=10 value="<?php echo $row_prod[new_price]?>"> 元<font style="color:red;">*</font>
    		</td>
			<td rowspan="8">
    			<img id="previewImg" src="../prod/images/prodphoto/<?php echo $row_prod[image_path]?>" style="cursor: hand;" onClick="window.open(this.src);" width="150" height="120" alt="点击查看大图"/>
       	...
       	<tr>
			<td width=80 align=center>首页显示</td>
  			<td>
  			  ...
  			  ?>
			  <input type="radio" name="showindex" value="0" <?php echo $noshow?> />不显示
			  <input type="radio" name="showindex" value="SHOWINDEX" <?php echo $show?>/>显示<font style="color:red;">*</font>
    		</td>
    	</tr>
       	<tr>
    	...
    	<tr>
  			...
  			<td  colspan="2">
			  	...
			  	<input type="submit" name="into_prod" style="height:30px;" value="修改产品信息">
				&nbsp;&nbsp;
