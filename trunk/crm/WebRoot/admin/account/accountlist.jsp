...
<body>
	...
	<html:form action="/admin/sick?task=sickList" method="post">
	<table width="100%" border="0" align="center" cellpadding="2"
		cellspacing="1" class="tableBorder">
		<tr>
		...
		<tr>
			...
			病人名称:	<html:text property="sickname"  size="15"  />
			</td>
			<td>
	...
	<table id="listtab" width="98%" border="0" align="center" cellpadding="3"
		...
		<tr align="center" class="thstyle">
		 ...
		 <logic:present name="SickList">
          	<logic:iterate id="icd" name="SickList">          	 
				<tr align="center" style="cursor: hand;">
					...
					<td>
						<a href="${pageContext.request.contextPath}/admin/sick.do?task=toUpdateSick&id=${icd.id}"><img src="${pageContext.request.contextPath}/admin/images/edit.gif" border="0">[修改]</a>
						<a href="${pageContext.request.contextPath}/admin/sick.do?task=deleteSick&id=${icd.id}" onclick="return confirm('是否确定删除!');"><img src="${pageContext.request.contextPath}/admin/images/del.gif" border="0">[删除]</a>
					</td>
				</tr>					
	          </logic:iterate>
          </logic:present>
