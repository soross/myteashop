...
<body>
	...
	<table width="100%" border="0" align="center" cellpadding="2"
		...
		<tr>
			...
			门诊图像名称:	<html:text property="filename"  size="15"  />
			</td>
			<td>
					...
					<logic:present name="fileList">
	          			<logic:iterate id="file" name="fileList"> 
	          				<li style="float:left; position:relative;text-align:center;padding:5px 10px 25px 10px;">
								...
								<br><input type="button" value="删除" onclick="deleteFile('${file.id}','${file.filename}');">&nbsp;<input type="button" value="大图" onclick="bigPhoto('${file.filepath}');">
				    		</li>
						</logic:iterate>
		          	</logic:present>
	          	</div>
