        ...
        <td>
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50%" class="STYLE1">当前位置：年度积分查询</td>
                <td width="50%" ></td>
              </tr>
            </table>
           </td>
    ...
    <td>
       <table width="100%" border="0" cellspacing="0" cellpadding="0">
         <tr>
            ...
            <td align="center" >
              <br>
               <html:form action="/admin/score?task=searchYear">
                  <table width="700"  class="STYLE4" cellpadding="0" cellspacing="0" style="vertical-align: middle">
                     <tr>
                       ...
                       <td><html:text property="edate" style="width:100px; height:20px" onkeyup="value=value.replace(/[^\d]/g,'')"></html:text>(格式如:2009)</td>
      ...
      <tr>
        ...
        <td>
          ...
          <tr>
            ...
            <td width="14%" height="22" background="${pageContext.request.contextPath}/admin/images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">年所得积分</span></div></td>
            <td width="14%" height="22" background="${pageContext.request.contextPath}/admin/images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">年兑换积分</span></div></td>
            <td width="14%" height="22" background="${pageContext.request.contextPath}/admin/images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">年积分合计</span></div></td>
          </tr>
          ...
          <tr>
            <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${year.phone}</span></div></td>
            <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${year.year} </span></div></td>
            <td bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${year.total }</span></div></td>
            <td bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${year.change }</span></div></td>
            <td bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${year.balance }</span></div></td>
          </tr>
          </logic:iterate>
          </logic:present>
        </table></td>
