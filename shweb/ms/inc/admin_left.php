		...
		<CENTER>
							...
							<TABLE width="100%">
								<TBODY>
									...
									<TR>
										<TD>
											<IMG src="../images/menu.gif" align=absMiddle border=0>&nbsp;
									  		<A href="../config/banner.php" target=main>动画管理</A>
									  	</TD>
									</TR>
							        <TR>
							        	<TD>
							        		<IMG src="../images/menu.gif" align=absMiddle border=0>&nbsp;
									  		<A onClick="return confirm('提示：您确定要退出系统吗？')" href="../admin.php"  target=_parent>退出后台</A>
									  	</TD>
									</TR>
								</TBODY>
							</TABLE>
			...
			<TABLE class=Menu cellSpacing=0 style="margin-top:5px">
	 		...
	 		<TABLE class=Menu cellSpacing=0 style="margin-top:5px">
				<TBODY>
					<TR>
						<TH onClick="javascript:menu_tree('left_4');" align=middle>≡ 案例管理 ≡</TH>
					</TR>
					<TR id=left_4>
						<TD>
							<TABLE width="100%">
        						<TBODY>
									...
									<TR>
										<TD>
											<IMG src="../images/menu.gif" align=absMiddle border=0>&nbsp;
									  		<A href="../case/caseadd.php" target=main>添加案例</A>
									  	</TD>
									</TR>
 								</TBODY>
 							</TABLE>
							...
							<TABLE width="100%">
        						<TBODY>
							        <TR>
										<TD>
											<IMG src="../images/menu.gif" align=absMiddle border=0>&nbsp;
									  		<A href="../service/imms.php" target=main>客服管理</A>
									  	</TD>
									</TR>
 								</TBODY>
 							</TABLE>
